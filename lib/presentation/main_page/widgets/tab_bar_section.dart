      ...
      child: GlassCard(
        ...
        child: Column(
          children: [
            ...
            _buildSideItem(
                menuBarController, 0, "assets/svgs/house-regular-full.svg"),
            const SizedBox(
              height: 10,
            ),
            ...
            _buildSideItem(
                menuBarController, 2, "assets/svgs/thumbs-up-regular-full.svg"),
            const SizedBox(
              height: 10,
            ),
            _buildSideItem(
                menuBarController, 3, "assets/svgs/image-regular-full.svg"),
            const SizedBox(
              height: 10,
            ),
            _buildSideItem(
                menuBarController, 4, "assets/svgs/list-solid-full.svg"),
          ],
        ),
      ),
    );
